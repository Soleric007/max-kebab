                    ...
                    <div class="about-image-grid">
                        <div class="about-image-grid-item">
                            <div class="about-image-grid-inner mb-30">
                                <img src="<?php echo e(asset('assets/images/welcome/welcome-image-1.jpg')); ?>" alt="Max Kebab interior">
                            </div>
                            <div class="about-image-grid-inner mb-30">
                                <img src="<?php echo e(asset('assets/images/welcome/welcome-image-2.jpg')); ?>" alt="Freshly prepared menu items">
                            </div>
                        </div>
                        <div class="about-image-grid-item">
                            <div class="about-image-grid-inner fluid-height">
                                <img src="<?php echo e(asset('assets/images/welcome/welcome-image-3.jpg')); ?>" alt="Dining atmosphere">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/solomon/Herd/max-kebab/resources/views/pages/about.blade.php ENDPATH**/ ?>