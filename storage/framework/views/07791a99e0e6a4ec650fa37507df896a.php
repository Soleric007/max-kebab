<section class="testimonial-section p-tb-100 bg-black bg-overlay-1">
    <div class="container">
        <div class="section-title">
            <small>Review</small>
            <h2 class="color-white"><?php echo e($heading ?? 'Guests talk about the flavour, freshness, and service'); ?></h2>
        </div>
...
<?php /**PATH /Users/solomon/Herd/max-kebab/resources/views/partials/reviews.blade.php ENDPATH**/ ?>