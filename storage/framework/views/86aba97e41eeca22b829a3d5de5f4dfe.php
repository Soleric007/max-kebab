        ...
        <div class="mobile-nav">
            ...
            <div class="navbar-option mobile-navbar-option d-flex align-items-center">
                ...
                <div class="navbar-option-item navbar-option-cart">
                    <a href="<?php echo e(route('cart.index')); ?>" aria-label="Basket"><i class="flaticon-supermarket-basket"></i></a>
                    <?php if($cartCount > 0): ?>
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item mobile-only-nav-item">
                                <a href="<?php echo e(route('wishlist.index')); ?>" class="nav-link">WISHLIST <?php if($wishlistCount > 0): ?> (<?php echo e($wishlistCount); ?>) <?php endif; ?></a>
                            </li>
                            <li class="nav-item mobile-only-nav-item">
                                <a href="<?php echo e(route('cart.index')); ?>" class="nav-link">CART <?php if($cartCount > 0): ?> (<?php echo e($cartCount); ?>) <?php endif; ?></a>
                            </li>
                            <li class="nav-item mobile-only-nav-item">
                                <a href="<?php echo e(route('shop.index')); ?>" class="nav-link">ORDER NOW</a>
                            </li>
                        </ul>
